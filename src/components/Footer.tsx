    ...
    return(
        <>
            <div className="footer">
                ...
                <div className="footerColumn">
                    <h1>Find Me</h1>
                    <ABlank href="https://www.linkedin.com/in/hazel-belmont/" classes="flexRow alignedCenter"><img src={paths.images + "linkedin-logo.svg"} alt="" className="inverted footerImg" /> <h3>/benjamin-belmont-714a491ab</h3></ABlank>
